...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <!-- hides TEI header -->
    ...
    <xsl:template match="tei:TEI/tei:text/tei:front">    
        ...
        <xsl:result-document href="{concat('/Users/amyya/OneDrive/Desktop/Digital Humanities/FinalProject/', 'Sigla', '.html')}"> <html>
           <head>
           ...
           <body>
               <nav>
                   <ul>
                       ...
                       <li><a href="tacitusM.html">M readings</a></li>
                   </ul>
               </nav>
               <div id="home"> 
                   <h1>Sigla</h1>    
    ...
    <xsl:template match="//tei:div2">
        <xsl:variable name="part_num" select="position() - 1"/>
        <xsl:result-document
            href="{concat('/Users/amyya/OneDrive/Desktop/Digital Humanities/FinalProject/','Part0',$part_num, '.html')}">
            <html>
                <head>
                    <title>Tacitus Histories</title>                  
                     <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css" integrity="sha384-9gVQ4dYFwwWSjIDZnLEWnxCjeSWFphJiwGPXr1jddIhOegiu1FwO5qRGvFXOdJZ4" crossorigin="anonymous"/>
    ...
    <!-- puts a span around lem element -->
     ...
     <!-- nests a span element for the rdg and witDetail element -->
            <span class="tiptext" id="{concat('rdg-', $order)}">
    ...
    <xsl:template match="//tei:body/tei:div1/tei:div2/tei:div3/tei:p/tei:persName">         
        <a tabindex="0" class="btn btn-lg btn-danger" role="button" data-toggle="popover" data-trigger="focus" title="Info" data-content="{@ref}"><xsl:value-of select="."/></a>
       </xsl:template>
  </xsl:stylesheet>
